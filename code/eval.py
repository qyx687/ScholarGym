...
def main():
    ...
    parser.add_argument('--postprocess_event_workers', type=int, choices=[1], default=1, help='Sequential package: fixed to 1')
    parser.add_argument('--postprocess_selector_concurrency', type=int, choices=[1], default=1, help='Sequential package: fixed to 1')
    parser.add_argument('--postprocess_embedding_concurrency', type=int, choices=[1], default=1, help='Sequential package: fixed to 1')
