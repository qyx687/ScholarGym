...
BASELINE_ROWS="${BASELINE_RUN}/onepass_artifacts/baseline/paper_rows.jsonl"
...
OURS_NATIVE="${REPO_ROOT}/ScholarGym_PerSubquery_Online/eval_results_online_s2_native_v4_20260727/qwen3-30b-a3b-instruct-2507_complex_vector_deep_research_topk-[5, 10, 20]_maxq-10_instruct_non-structured_NONE_per_subquery_online_dynamic_rerank_v1_type-s2-native_online_s2_native_v4_20260727/online_artifacts/paper_rows.jsonl"
...
exec "${PYTHON_BIN}" \
  ...
  --benchmark "${BENCHMARK}" \
  --flat "Controlled/Semantic" "${BASELINE_ROWS}" observed_retrieval_rank \
